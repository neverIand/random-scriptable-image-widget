...
//  =
//   "This will be the JSON string with all Map replaced, generated by the webpage";
// let parsedConfig = JSON.parse(SCRIPT_CONFIG, reviver);
let SCRIPT_CONFIG = "";
